	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-validate form-horizontal well">
        ...
        <div class="row">
			...
			<div  class="control-group pull-left">
				<div class="control-label"><label class="pull-left"><?php echo JText::_('COM_USERS_LOGIN_REMEMBER_ME') ?><input id="remember" type="checkbox" name="remember" class="inputbox pull-left" value="yes"/></label> </div>

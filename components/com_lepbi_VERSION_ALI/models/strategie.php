...
class Strategie  {
	...
	function AfficheTypeRapport($id_echantillon) {
		$db = JFactory::getDBOGBMNet();
		$query = "Select 'META1' as type, revision_rapport_meta_1 as revision
				from rapport_meta_1
				where echantillon_rapport_meta_1 = " . $id_echantillon . "
				UNION
				Select 'META050' as type, revision_rapport_meta_050 as revision
				from rapport_meta_050
				where echantillon_rapport_meta_050 = " . $id_echantillon . "
				UNION
				Select 'META269' as type, revision_rapport_meta_269 as revision
				from rapport_meta_269
				where echantillon_rapport_meta_269 = " . $id_echantillon . "
				UNION
				Select 'META269v2' as type, revision_rapport_meta_269_v2 as revision
				from rapport_meta_269_v2
				where echantillon_rapport_meta_269_v2 = " . $id_echantillon . "
				UNION
				Select 'META269v3' as type, revision_rapport_meta_269_v3 as revision
				from rapport_meta_269_v3
				where echantillon_rapport_meta_269_v3 = " . $id_echantillon . "
				UNION
				Select 'MATERIAU' as type, revision_rapport_materiau as revision
				from rapport_materiau
				where echantillon_rapport_materiau = " . $id_echantillon . "
				UNION
				Select 'MEST' as type, revision_rapport_mest as revision
				from rapport_mest

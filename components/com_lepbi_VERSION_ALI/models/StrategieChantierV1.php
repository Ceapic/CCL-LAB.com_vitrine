...
class StrategieChantierV1 {
    ...
    static function listStrategieEchantillon($id) {
        ...
        $resultats = $GLOBALS["DB"]->loadObjectList();
    ...
    static function getProcessusClient($idClient) {
        ...
        $datas = $GLOBALS["DB"]->loadObjectList();
    ...
    static function listStrategieEchantillonRecapProcessus($idStrategieChantierV1) {
        ...
        $GLOBALS["DB"]->setQuery($reqProcessus);
    ...
    static function getResultatAndCofrac($idEchantillon) {
        ...
        $modeleStrategie  = new CEAPICWorldModelStrategie();
        $model2 = new CEAPICWorldModelSynthese();

        $typeRapport = $modeleStrategie->AfficheTypeRapport($idEchantillon)->type;

        if ($typeRapport == "META050" || $typeRapport == "META269v3") {
            $Analyses = $model2->getAnalysesEchantillonMETAv1($idEchantillon, 1);
            if (count($Analyses) != 0) {
        ...
        if ($typeRapport == "MEST") {
            $AfficheRapport = $model2->AfficheRapportEchantillonMEST($idEchantillon);

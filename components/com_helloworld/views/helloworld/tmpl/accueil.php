...
<div style="display: flex; flex-direction:column ; align-items:center; justify-content:center;">
  <div>
    <h3 class="text-info lead"><strong>nous ont fait confiance</strong></h3>
  </div>
  <div>
...
<script>
  jQuery(document).ready(function($) {
    $('.owl-carousel').owlCarousel({
      ...
      // No navText here; we'll override via CSS
    });
  });
  ...
  jQuery(document).ready(function($) {
    ...
    var imageWidth = images.first().outerWidth(true); // includes margins, if any

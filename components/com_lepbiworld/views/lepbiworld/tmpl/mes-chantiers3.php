...
<script language="javascript" type="text/javascript">
	...
	function DownloadAllRapport(){
		...
		var page = "<?php echo JURI::root(); ?>index.php?option=com_lepbiworld&task=DownloadAllRapportChantier&format=raw&id_chantier="+ jQuery('#id_chantier').val() +"&ref_chantier="+ ref_chantier +"&id_client=<?php echo $id_client; ?>&type_client=<?php echo $type_client; ?>&tokenclient=<?php echo $token_client; ?>";
		window.open(page,'_blank' );
	}

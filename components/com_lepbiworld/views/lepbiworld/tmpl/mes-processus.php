...
// JHtml::script("components/com_lepbiworld/js/Canvas/canvasjs.min.js");
JHtml::script("components/com_lepbiworld/js/Chart/Chart.min.js");
...
$url = $model->GetRemoteToken() . "/index.php?option=com_lepbiworld&task=ListeProcessusClient&id_client=" . $id_client . "&token=" . $token . "&format=raw";

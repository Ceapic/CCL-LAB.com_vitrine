...
$url = $model->GetRemoteToken() . "/index.php?option=com_lepbiworld&task=ListeClient&token=" . $token . "&format=raw";
// echo $url;
...
<div class="panel panel-primary">
	...
	<form action="#" method="post">
		...
		<button name="validation_client_user" style="margin-left: 5px;" class="lepbiworld_button_radius lepbiworld_button_blue lepbiworld_button_shadow">Valider</button>
	</form>
</div>

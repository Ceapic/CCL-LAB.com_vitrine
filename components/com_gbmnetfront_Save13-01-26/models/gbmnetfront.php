...
class Gbmnetfront {
	...
	static function CheckRemoteToken($token) {
		$config = JFactory::getConfig();
	...
	static function GetRemoteToken() {
		$config = JFactory::getConfig();
		return $config->get('remotetoken');
	}

	static function getUrlBack() {
		$config = JFactory::getConfig();
		return $config->get('urlBack');
	}

	static function getUrlVitrine() {
		$config = JFactory::getConfig();
		return $config->get('urlVitrine');
	}

	static function CreateToken($key_token) {
		$config = JFactory::getConfig();
	...
	static function CheckLocalToken($key_token) {
		$config = JFactory::getConfig();
		$dbprefix = $config->get('dbprefix');
	...
	static function AfficheUser($id_user) {
		$config = JFactory::getConfig();
		$dbprefix = $config->get('dbprefix');

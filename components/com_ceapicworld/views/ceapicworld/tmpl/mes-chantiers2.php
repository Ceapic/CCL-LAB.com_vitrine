...
<script language="javascript" type="text/javascript">
	...
	// function(){
		...
		// jQuery.ajax({
			// url: "<?php echo JURI::root(); ?>index.php?option=com_ceapicworld&task=SendReservation&format=raw&id_client=<?php echo $id_client; ?>&type_client=<?php echo $type_client; ?>&tokenclient=<?php echo $token_client; ?>",
			// dataType: 'POST',
			// data: {

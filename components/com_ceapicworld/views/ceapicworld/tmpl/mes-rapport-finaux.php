<?php
	...
	$url = $model->GetRemoteToken()."/index.php?option=com_ceapicworld&task=ListeRapportsFinaux&id_client=".$id_client."&token=".$token."&format=raw";

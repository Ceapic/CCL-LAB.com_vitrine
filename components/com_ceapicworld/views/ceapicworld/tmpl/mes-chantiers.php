...
<script language="javascript" type="text/javascript">
	...
	function ClickChantier(object, id_chantier) {
		...
		let temp = "<?php echo JURI::root(); ?>index.php?option=com_ceapicworld&task=ListeRapportChantier&format=raw&id_chantier=" + id_chantier + "&id_client=<?php echo $id_client; ?>&type_client=<?php echo $type_client; ?>&tokenclient=<?php echo $token_client; ?>";
	...
	function ChangeStrategie() {
		...
		let url = "<?php echo JURI::root(); ?>index.php?option=com_ceapicworld&task=SuiviStrategieLoader&id_strategie=" + idStrategie + "&id_echantillon=" + id_echantillon + "&id_chantier=" + id_chantier + "&ref_strategie=" + ref_strategie + "&format=raw&id_client=<?php echo $id_client; ?>&type_client=<?php echo $type_client; ?>&tokenclient=<?php echo $token_client; ?>";

		jQuery.ajax({
			url: "<?php echo JURI::root(); ?>index.php?option=com_ceapicworld&task=SuiviStrategieLoader&id_strategie=" + idStrategie + "&id_echantillon=" + id_echantillon + "&id_chantier=" + id_chantier + "&ref_strategie=" + ref_strategie + "&format=raw&id_client=<?php echo $id_client; ?>&type_client=<?php echo $type_client; ?>&tokenclient=<?php echo $token_client; ?>",
			success: function(data) {
				jQuery("#suivi_chantier_loader").empty();
				if (id_echantillon != 0) {
	...
	function TelechargeStrategie() {
		...
		var page = "<?php echo JURI::root(); ?>index.php?option=com_ceapicworld&task=AfficheStrategie&format=raw&ref=" + reference + "&id_strategie=" + idStrategie + "&type_strategie=" + typeStrategie + "&id_client=<?php echo $id_client; ?>&type_client=<?php echo $type_client; ?>&tokenclient=<?php echo $token_client; ?>";
		//depart
		window.open(page, '_blank');
	}

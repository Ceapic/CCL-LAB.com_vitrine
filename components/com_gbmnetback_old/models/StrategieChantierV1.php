...
class StrategieChantierV1
{
    ...
    static function getResultatAndCofrac($idEchantillon)
    {
        ...
        if ($typeRapport == "MEST") {
            $AfficheRapport_Analyse = $modelSynthese->AfficheAnalyseEchantillonMEST_StratChantierv1($idEchantillon, StrategieChantierV1::TYPE_DOSSIER_INTERNE);
            $AfficheRapport = $modelSynthese->AfficheRapportEchantillonMEST_StratChantierv1($idEchantillon);
            ...
            if (count($AfficheRapport_Analyse) != 0) {
                ...
                die("idk anymore my brain hurts");
            }
        }

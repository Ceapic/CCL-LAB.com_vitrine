...
class gbmnetBackController extends JControllerLegacy
{
    ...
    function AfficheRapportBack()
    {
        ...
        if ($checktoken == "true" || $checktoken == true) {
            ...
            if ($CheckClientEchantillon == "true") {
                ...
                // echo "data";
                // var_dump($oneRapport->nom_client);
                // var_dump($oneRapport->nom_chantier);
                // var_dump($type_rapport);
                // var_dump($oneRapport->ref_echantillon);
                // var_dump($oneRapport->revision);
                ...
                // $oneRapport->path_rapport_meta_050 joris added this idk exatly what he ment by it
                // echo "hello";
                // var_dump($file);
                // die();
    ...
    //////////////////////////////////////////// mes-chantier  TelechargeStrategie  ///////////////////////////////////////////
        ...
        if ($checktoken == "true" || $checktoken == true) {
            ...
            if ($checkClientStrategie == "true") {
                if ($type_strategie == 1) {
                    ...
                    $filelocation = $config->get('filelocation');
                    // echo "data";
                    // var_dump($oneStrategie->nom_client);
                    // var_dump($oneStrategie->nom_chantier);
                    // var_dump($oneStrategie->nom_qualification);
                    // var_dump($oneStrategie->ref_echantillon);
                    // var_dump($oneStrategie->revision_strategie_chantier);

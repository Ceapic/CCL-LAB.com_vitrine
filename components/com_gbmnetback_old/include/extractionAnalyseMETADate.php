...
$rowcount = 2;
$test =$model-> ListeAnalyseMETAv0Client($id_client, $date_debut, $date_fin);
var_dump($test);

$test2 =$model-> getAnalysesMetaV1Client($id_client, $date_debut, $date_fin);

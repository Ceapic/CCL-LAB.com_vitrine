<?php
	...
	$rowcount = 2;
		...
		foreach($model->ListeAnalyseMETAv0Client($id_client, $date_debut, $date_fin) as $oneEchantillon){
			...
			$objPHPExcel->setActiveSheetIndex(0)
				...
				->setCellValue('I'.$rowcount, $oneEchantillon->nom_analyse_externe_prestation_objectif)
	...
	// header('Content-Disposition: attachment;filename="extract-META-ext-'.date('Ymd-His').'.xlsx"');

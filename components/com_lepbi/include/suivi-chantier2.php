...
<head>
        ...
        <base href="https://ceapic.fr/index.php/mon-espace/suivi-chantier" />
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<meta name="generator" content="Joomla! - Open Source Content Management" />
	<title>Suivi chantier</title>
	<link href="/templates/tx_zenith/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
	<link href="/media/system/css/calendar-jos.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="/components/com_ceapicworld/js/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="/components/com_ceapicworld/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="/components/com_ceapicworld/js/DataTables/media/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" media="screen" />
	...
	<script type="application/json" class="joomla-script-options new">{"system.paths":{"root":"","base":""},"joomla.jtext":{"JLIB_FORM_FIELD_INVALID":"Champ invalide&#160;:&#160;"},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
	...
	<script src="/components/com_ceapicworld/js/jquery/jquery-1.12.4.min.js" type="text/javascript"></script>
	<script src="/components/com_ceapicworld/js/jquery-ui-1.12.1/jquery-ui.min.js" type="text/javascript"></script>
	<script src="/components/com_ceapicworld/js/jquery-ui-1.12.1/jquery.ui.datepicker-fr.js" type="text/javascript"></script>
	<script src="/components/com_ceapicworld/js/DataTables/media/js/jquery.dataTables.min.js" type="text/javascript"></script>
	<script src="/libraries/expose/interface/js/equalheight.js" type="text/javascript"></script>
	<script src="/libraries/expose/interface/js/breakpoints.js" type="text/javascript"></script>
	<script src="/libraries/expose/interface/js/offcanvas.js" type="text/javascript"></script>
	<script src="/templates/tx_zenith/js/template.js" type="text/javascript"></script>
	<!--[if lt IE 9]><script src="/media/system/js/polyfill.event.js?fc04069a3e74b8913f187598edba34e2" type="text/javascript"></script><![endif]-->
	<script src="/media/system/js/keepalive.js?fc04069a3e74b8913f187598edba34e2" type="text/javascript"></script>
...
<table align="center" style="width: 98%; border-collapse: collapse; border: 1px solid; margin-top: 10px;" border="0">
	<tr style="background: #E2EFD9;"><td style="padding: 5px; width: 100%; border: 1px solid;">Mesures réalisées</td></tr>
	<tr style="background: #FFF2CC;"><td style="padding: 5px; width: 100%; border: 1px solid;">Mesures commandées mais non réalisées</td></tr>
	<tr style="background: #F2D7D5;"><td style="padding: 5px; width: 100%; border: 1px solid;">Mesures préconisées par la stratégie mais non encore commandées</td></tr>
</table>
...
foreach($model->ListeEchantillonStrategieChantier($id_echantillon) as $oneEchantillon){
	...
	if($oneEchantillon->ref_echantillon <> "0"){
		...
		$show_class = "show_rapport_echantillon"; $href = "href"; if(preg_match("/^VS-/",$oneEchantillon->ref_echantillon)){ $show_class = ""; $href = "";}
	?>
			<tr style="background: #E2EFD9;" class="row_echantillon">
				<td style="width: 19%"><p class="<?php echo $show_class; ?>" link="<?php echo $oneEchantillon->id_echantillon; ?>" hash="<?php echo $hash; ?>"><span class="<?php echo $href; ?>"><?php echo $oneEchantillon->ref_echantillon.$cofrac; ?></span></a></td>
...
?>
	...
	$tableliste_echantillon = "";
	foreach($liste_echantillon as $oneEchantillon){
		$tableliste_echantillon.=  '<tr>';
		$tableliste_echantillon.= '<td>'.$oneEchantillon['contexte_mesure'].'</td>';
		$tableliste_echantillon.= '<td>'.$oneEchantillon['zone'].'</td>';
		$tableliste_echantillon.= '<td>'.$oneEchantillon['mesure'].'</td>';
		$tableliste_echantillon.= '</tr>';
	}
	echo "<table class=\"table_gbmnet\">".$tableliste_echantillon."</table>";
	...
	jQuery( function() {
		...
		jQuery('.h3_zone').each(function(){
			...
			zone.next().find('.date_pose').each(function(){
				...
				if(date > bigger[0]){ bigger[0] = date; bigger[1] = jQuery(this).text();}
			});
		...
		jQuery('.mesure_to_command').each(function(){
			...
			var facultatif = "row_obligatoire"; var facultatif_texte = ""; if(row.find('td:eq(3)').text() == 'Facultatif*'){ facultatif = "row_facultatif"; facultatif_texte = " (facultatif)"; }

...
require_once(URL_MODELE . "management.php");
$model = new management;

// ini_set('display_errors', 0);
// error_reporting(0);
// require_once JPATH_LIBRARIES . '/PHPExcel/PHPExcel.php';
...
foreach ($ListeEchantillonDate as $oneEchantillon) {
	...
	if (count($Rapports) <> 0) {
		...
		if ($oneEchantillon->analyse_echantillon == 2) {
			...
			if ($oneRapport->nombre_couche_rapport_materiau == 1) {
				$TypeFibre1 = "";
				$ResultatAnalyse1 = "";
				if ($oneRapport->resultat_analyse_1_rapport_materiau == 1) $ResultatAnalyse1 = "Présence :";
				if ($oneRapport->resultat_analyse_1_rapport_materiau == 2) $ResultatAnalyse1 = "Absence";
				if ($oneRapport->resultat_analyse_1_rapport_materiau == 3) $ResultatAnalyse1 = "Trace :";
			...
			if ($oneRapport->nombre_couche_rapport_materiau == 2) {
				...
				$TypeFibre2 = "";
				$ResultatAnalyse2 = "";
				if ($oneRapport->resultat_analyse_2_rapport_materiau == 1) $ResultatAnalyse2 = "Présence :";
				if ($oneRapport->resultat_analyse_2_rapport_materiau == 2) $ResultatAnalyse2 = "Absence";
				if ($oneRapport->resultat_analyse_2_rapport_materiau == 3) $ResultatAnalyse2 = "Trace :";
			...
			if ($oneRapport->nombre_couche_rapport_materiau == 3) {
				...
				$TypeFibre3 = "";
				$ResultatAnalyse3 = "";
				if ($oneRapport->resultat_analyse_3_rapport_materiau == 1) $ResultatAnalyse3 = "Présence :";
				if ($oneRapport->resultat_analyse_3_rapport_materiau == 2) $ResultatAnalyse3 = "Absence";
				if ($oneRapport->resultat_analyse_3_rapport_materiau == 3) $ResultatAnalyse3 = "Trace :";
	...
	if (count($Rapports) <> 0) {
		...
		if ($oneRapport->humidification_humidification_rapport_meta_1_2 == 1) {
			$humidification .= $separator . "Humidification du matériau par pulvérisation";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->mouillage_humidification_rapport_meta_1_2 == 1) {
			$humidification .= $separator . "Mouillage par inondation des matériaux";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->brumisation_humidification_rapport_meta_1_2 == 1) {
			$humidification .= $separator . "Brumisation";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->impregnation_humidification_rapport_meta_1_2 == 1) {
		...
		if (($oneRapport->aspiration_captage_rapport_meta_1_2 == 1) || ($oneRapport->aspirateur_the_aspiration_captage_rapport_meta_1_2 == 1)) {
			$captage .= $separator . "Captage des poussières à la source";
		}
		if ($captage <> "") {
			$separator = ", ";
		}
		if (($oneRapport->aspirateur_the_depoirte_aspiration_captage_rapport_meta_1_2 == 1) || ($oneRapport->outil_the_depoirte_aspiration_captage_rapport_meta_1_2 == 1)) {
		...
		if ($oneRapport->isolement_confinement_rapport_meta_1_2 == 1) {
			$isolation .= $separator . "Isolement et calfeutrement simple";
		}
		if ($isolation <> "") {
			$separator = "\n";
		}
		if ($oneRapport->static_confinement_rapport_meta_1_2 == 1) {
			$isolation .= $separator . "Confinement statique";
		}
		if ($isolation <> "") {
			$separator = "\n";
		}
		if ($oneRapport->dynamic_confinement_rapport_meta_1_2 == 1) {
			$isolation .= $separator . "Confinement dynamique";
		}
	...
	if (count($Rapports) <> 0) {
		...
		if ($oneRapport->aucune_humidification_rapport_meta_269 == 1) {
			$humidification .= $separator . "Absence d'humidification";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->humidification_humidification_rapport_meta_269 == 1) {
			$humidification .= $separator . "Humidification du matériau par pulvérisation";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->mouillage_humidification_rapport_meta_269 == 1) {
			$humidification .= $separator . "Mouillage par inondation des matériaux";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->brumisation_impregnation_humidification_rapport_meta_269 == 1) {
			$humidification .= $separator . "Brumisation";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->nebulisation_impregnation_humidification_rapport_meta_269 == 1) {
			$humidification .= $separator . "Nébulisation";
		}
		if ($humidification <> "") {
			$separator = ", ";
		}
		if ($oneRapport->impregnation_humidification_rapport_meta_269 == 1) {
			$humidification .= $separator . "Imprégnation à cœur du matériau";
		}
		...
		if ($oneRapport->aucune_captage_rapport_meta_269 == 1) {
			$captage .= $separator . "Absence de captage des poussières";
		}
		if ($captage <> "") {
			$separator = ", ";
		}
		if ($oneRapport->source_captage_rapport_meta_269 == 1) {
			$captage .= $separator . "Captage des poussières à la source";
		}
		if ($captage <> "") {
			$separator = ", ";
		}
		if ($oneRapport->aspiration_captage_rapport_meta_269 == 1) {
			$captage .= $separator . "Captage des poussières avec aspiration déportée";
		}
		if ($captage <> "") {
			$separator = ", ";
		...
		if ($oneRapport->static_confinement_rapport_meta_269 == 1) {
			$isolation .= $separator . "Confinement statique et renouvellement d'air";
		}
		if ($isolation <> "") {
			$separator = "\n";
		}
		...
		if ($oneRapport->dynamic_confinement_rapport_meta_269 == 1) {
			$isolation .= $separator . "Confinement dynamique avec mise en dépression";
		}
		if ($isolation <> "") {
			$separator = "\n";
		}
	...
	if (count($Rapports) <> 0) {
		...
		if ($oneRapport->flocage_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Flocage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->calorifugeage_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Calorifugeage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->faux_plafond_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Faux Plafond";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->dalle_sol_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Dalle de sol";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->carrelage_sol_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Carrelage au sol";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->faience_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Faïence";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->plinthe_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Plinthe";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_dalle_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Colle de Dalle";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_carrelage_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Colle de Carrelage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_faience_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Colle de Faïence";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_plinthe_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Colle de Plinthe";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->fibrociment_conduit_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Fibrociment (conduit)";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->fibrociment_plaque_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Fibrociment (plaque)";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->ciment_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Ciment";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->enduit_peinture_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Enduit / Peinture";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->platre_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Plâtre";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->reagreage_chape_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Ragréage / Chape";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->mortier_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Mortier";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_vitrage_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Joints vitrage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_bride_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Joints de bride";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_mastique_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Mastic et autres joints";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->etancheite_bitumeux_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Revêtement / Etanchéité bitumineux ";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->enrobe_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Revêtement routier / Enrobés";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->element_friction_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Eléments de friction";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->clapet_coupe_feu_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Clapet coupe-feu";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->porte_coupe_feu_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Porte coupe-feu";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->panocell_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Panocell";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->panneau_sandwich_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Panneau sandwich";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->carton_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Cartons";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->feutre_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Feutres";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->textile_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Textiles";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->mousse_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Mousse";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->bourre_vrac_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . "Bourres en vrac";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->autre_materiau_rapport_meta_269_v2 == 1) {
			$materiaux .= $separator . $oneRapport->autre_materiau_texte_rapport_meta_269_v2;
		}
		...
		if ($oneRapport->arrachage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Arrachage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->balayage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Balayage ";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->brossage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Brossage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->carottage_forage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Carottage / Forage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->cassage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Cassage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->burinage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Burinage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->piquage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Piquage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->demolition_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Démolition";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->recouvrement_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Doublage / Encoffrement / Recouvrement";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->decapage_lustrage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Décapage / Lustrage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->decollage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Décollage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->decoupage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Découpage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->percage_sciage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Tronçonnage / Perçage / Sciage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->deconstruction_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Désemboitage / Déconstruction";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->sablage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Grenaillage / Hydrogommage / Sablage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->nettoyage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Nettoyage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->ramassage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Ramassage / Manutention / Conditionnement";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->pelletage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Pelletage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->poncage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Ponçage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->procede_chimique_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Procédé chimique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->rabotage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Rabotage / Rectification / Fraisage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->raclage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Raclage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->technique_thp_uph_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Technique THP / UPH";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->vissage_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . "Visage / Tirage de câble / Réglage";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->autre_technique_rapport_meta_269_v2 == 1) {
			$technique .= $separator . $oneRapport->technique_texte_rapport_meta_269_v2;
		}
		...
		if ($oneRapport->isolation_rapport_meta_269_v2 == 1) {
			...
			if ($oneRapport->isolement_confinement_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Isolement et calfeutrement simple";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->static_confinement_sans_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Confinement statique sans renouvellement d’air";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->static_confinement_avec_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Confinement statique avec renouvellement d’air";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->dynamic_10_6_10_confinement_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Confinement dynamique, dépression -10P, renouv 6 à 10 V/h";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->dynamic_10_6_20_confinement_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Confinement dynamique, dépression -10P, renouv 10 à 20 V/h";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->sac_isolement_confinement_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Sac à manche";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->boite_isolement_confinement_rapport_meta_269_v2 == 1) {
				$isolation .= $separator . "Boîte à gant";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->protection_simple_confinement_rapport_meta_269_v2 == 1) {
	...
	if (count($Rapports) <> 0) {
		...
		if ($oneRapport->flocage_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Flocage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->calorifugeage_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Calorifugeage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->faux_plafond_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Faux Plafond";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->frigorifuge_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Frigorifuge";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->dalle_sol_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Dalle de sol";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->lino_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Lino, moquette, lé";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->carrelage_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Carrelage au sol";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->faience_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Faïence";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->plinthe_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Plinthe";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->peinture_interieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Peinture intérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->peinture_exterieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Peinture extérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->peinture_metal_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Peinture sur support métallique";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->enduit_projete_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Enduit projeté (progypsol)";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->enduit_lissage_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Enduit de lissage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->enduit_exterieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Enduit extérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->enduit_metal_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Enduit sur support métallique";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->mortier_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Mortier";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->platre_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Plâtre";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->ciment_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Ciment";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->ragreage_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Ragréage / chape maigre";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_bitumineuse_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Colle bitumineuse";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_dalle_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Colle de dalle";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_lino_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Colle de lino, moquette, lé";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_plinthe_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Colle de Plinthe";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->colle_faience_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Colle de Faïence";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->canalisation_interieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Canalisation / Gaine Fibro intérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->canalisation_exterieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Canalisation / Gaine Fibro extérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->plaque_fibro_interieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Plaque Fibro intérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->plaque_fibro_exterieur_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Plaque Fibro extérieur";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->tuiles_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Tuiles, Ardoises";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->toitures_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Toiture, bardage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->etancheite_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Etanchéité bitumineuse";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_vitrage_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Joints vitrage";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_fenetre_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Joints cadre fenêtres";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_bride_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Joints de bride";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->joint_installation_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Joints d’installation";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->mastic_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Mastic et autres joints";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->revetement_routier_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Revêtement routier/enrobés";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->friction_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Eléments de friction (freins)";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->clapet_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Clapet coupe-feu";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->porte_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Porte coupe-feu";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->tresse_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . "Tresse amiantée";
		}
		if ($materiaux <> "") {
			$separator = ", ";
		}
		if ($oneRapport->autre_materiau_rapport_meta_269_v3 == "1") {
			$materiaux .= $separator . $oneRapport->autre_materiau_texte_rapport_meta_269_v3;
		}
		...
		if ($oneRapport->arrachage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Arrachage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->desemboitage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Désemboitage / Déconstruction manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->depose_dessous_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Dépose par le dessous manuelle";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->depose_dessus_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Dépose par le dessus manuelle";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->ramassage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Ramassage / Nettoyage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->manutention_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Manutention / conditionnement manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->pelletage_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Pelletage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->burinage_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Burinage / piquage / cassage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->raclage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Raclage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->grattage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Grattage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->balayage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Balayage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->brossage_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Brossage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->poncage_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Ponçage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->encoffrement_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Encoffrement / recouvrement manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->vissage_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Vissage / Dévissage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->decoupage_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Découpage manuel";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->autre_technique_manuelle_rapport_meta_269_v3 == "1") {
			$technique .= $separator . $oneRapport->technique_manuelle_texte_rapport_meta_269_v3 . " manuel";
		}

		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->poncage_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Ponçage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->rabotage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Rabotage / Rectification mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->burinage_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Burinage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->cassage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Cassage / piquage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->tronconnage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Tronçonnage / Perçage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->decoupage_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Découpage / sciage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->brossage_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Brossage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->pelletage_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Pelletage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->sablage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Sablage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->carottage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Carottage / Forage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->vissage_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Vissage / Dévissage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->demolition_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Démolition mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->decapage_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Décapage / Lustrage mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->thp_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Jet Très Haute Pression (THP) mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->chimique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . "Procédé chimique mécanique";
		}
		if ($technique <> "") {
			$separator = ", ";
		}
		if ($oneRapport->autre_technique_mecanique_rapport_meta_269_v3 == "1") {
			$technique .= $separator . $oneRapport->technique_mecanique_texte_rapport_meta_269_v3 . " mécanique";
		}
		...
		if ($oneRapport->humidification_rapport_meta_269_v3 == "1") {
			...
			if ($oneRapport->humidification_humidification_rapport_meta_269_v3 == "1") {
				$humidification .= $separator . "Humidification des matériaux par pulvérisation";
			}
			if ($humidification <> "") {
				$separator = ", ";
			}
			if ($oneRapport->mouillage_humidification_rapport_meta_269_v3 == "1") {
				$humidification .= $separator . "Mouillage par inondation des matériaux";
			}
			if ($humidification <> "") {
				$separator = ", ";
			}
			if ($oneRapport->impregnation_humidification_rapport_meta_269_v3 == "1") {
				$humidification .= $separator . "Imprégnation à cœur des matériaux";
			}
			if ($humidification <> "") {
				$separator = ", ";
			}
			if ($oneRapport->brumisation_impregnation_humidification_rapport_meta_269_v3 == "1") {
				$humidification .= $separator . "Brumisation dans la zone";
			}
			if ($humidification <> "") {
				$separator = ", ";
			}
			if ($oneRapport->nebulisation_impregnation_humidification_rapport_meta_269_v3 == "1") {
		...
		if ($oneRapport->captage_rapport_meta_269_v3 == "1") {
			...
			if ($oneRapport->source_captage_rapport_meta_269_v3 == "1") {
				$captage .= $separator . "Captage des poussières à la source (aspi fixé à l'outil)";
			}
			if ($captage <> "") {
				$separator = ", ";
			}
			if ($oneRapport->aspiration_deporte_proche_captage_rapport_meta_269_v3 == "1") {
				$captage .= $separator . "Captage des poussières avec aspiration déportée au plus proche de l'outil";
			}
			if ($captage <> "") {
				$separator = ", ";
			}
			if ($oneRapport->aspiration_deporte_captage_rapport_meta_269_v3 == "1") {
				$captage .= $separator . "Captage des poussières avec aspiration déportée";
			}
			if ($captage <> "") {
				$separator = ", ";
			}
			if ($oneRapport->localise_captage_rapport_meta_269_v3 == "1") {
		...
		if ($oneRapport->isolation_rapport_meta_269_v3 == "1") {
			...
			if ($oneRapport->simple_peau_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Protection simple peau sans calfeutrement";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->isolement_confinement_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Isolement et calfeutrement simple";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->static_confinement_sans_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Confinement statique sans renouvellement d’air";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->static_confinement_avec_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Confinement statique avec renouvellement d’air";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->dynamic_10_6_10_confinement_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Confinement dynamique, dépression -10P, renouv 6 à 10 V/h";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->dynamic_10_6_20_confinement_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Confinement dynamique, dépression -10P, renouv 10 à 20 V/h";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->sac_isolement_confinement_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Sac à manche";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->boite_isolement_confinement_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Boîte à gant";
			}
			if ($isolation <> "") {
				$separator = ", ";
			}
			if ($oneRapport->protection_simple_confinement_rapport_meta_269_v3 == "1") {
				$isolation .= $separator . "Protection simple peau sans calfeutrement";
			}
		}
		...
		if ($oneRapport->duree_essai_rapport_meta_269_v3 == 0) {
			$oneRapport->duree_essai_rapport_meta_269_v3 = "1";
		}

		if ($oneRapport->volume_essai_rapport_meta_269_v3 == "") {
			$oneRapport->volume_essai_rapport_meta_269_v3 = 0;
		}
	...
	if (count($Rapports) <> 0) {
		...
		//$volume = str_replace(",", ".", $oneRapport->volume_total_rapport_meta_050) * 1000; // PK CETTE MULTIPLISCATION PAR  10000
		$volume = str_replace(",", ".", $oneRapport->volume_total_rapport_meta_050);
	}
	...
	if ($detect_meta == 1) {
		...
		$Analyses = $model->getAnalysesEchantillonMETAv1($oneEchantillon->id_echantillon, 1);
		$oneAnalyse = $Analyses[0];
		...
		if (count($Analyses) <> 0) {
			...
			// ===== FORMAT DATAS ======================================================================================================
			// =========================================================================================================================
			$SA_litre                 = number_format($oneAnalyse->sa_concentration, 2, ",", "");
			$SA_filtre                = number_format($oneAnalyse->sa_densite_filtre, 0, ",", "");
			$id_analyse 			  = $oneAnalyse->id;
			$type_fibre               = $oneAnalyse->type_fibres;
			$date_analyse 			  = date("d/m/Y", strtotime($oneAnalyse->date_analyse));
			$nombre_fibre             = str_replace(".", ",", $oneAnalyse->nbr_fibres);
			$total_filtre             = str_replace(".", ",", $oneAnalyse->nbr_filtres);
			$nombre_champ             = str_replace(".", ",", $oneAnalyse->nbr_champs);
			$nombre_grille 			  = $oneAnalyse->nbr_grilles;
			$surface_grille           = str_replace(".", ",", $oneAnalyse->surface_ouverture);
			$fraction_filtre          = str_replace(".", ",", $oneAnalyse->fraction_moyenne);
			$incertitude_labo 		  = $oneAnalyse->incertitude_labo;
			$surface_filtration       = str_replace(".", ",", $oneAnalyse->surface_filtration);

			$concentration_calculee   = number_format($oneAnalyse->concentration_calcule, 2, ",", "");
			$resultat 				  = number_format($oneAnalyse->concentration_normalise, 2, ",", "");

			$densite_filtre_calculee   = number_format($oneAnalyse->densite_filtre_calcule, 0, ",", "");
			$densite_filtre_normalisee = number_format($oneAnalyse->densite_filtre_normalise, 0, ",", "");

			$cinf_concentration = ($nombre_fibre < 4) ? "/" : number_format($oneAnalyse->cinf_concentration, 2, ",", "");
			$csup_concentration = number_format($oneAnalyse->csup_concentration, 2, ",", "");

			if ($nombre_fibre < 4) $resultat = "<" . $resultat;
			if ($nombre_fibre < 4) $densite_filtre_normalisee = "<" . $densite_filtre_normalisee;

			$intervalle_confiance_filtre = $oneAnalyse->cinf_densite_filtre . " < D < " . $oneAnalyse->csup_densite_filtre;
			$intervalle_confiance_litre = "/ < C < " . $csup_concentration;

			if ($nombre_fibre >= 4) $intervalle_confiance_litre = $cinf_concentration . " < C < " . $csup_concentration;

			$cinf = "/";
			if ($nombre_fibre >= 4) $cinf = number_format($oneAnalyse->cinf_concentration, 2, ",", "");

			$csup = number_format($oneAnalyse->csup_concentration, 2, ",", "");
			...
			$inanalysable_texte_reception = "";
			if (
				$oneAnalyse->decision_decoupe == "Inanalysable" ||
				$oneAnalyse->decision_grille  == "Inanalysable"
			) {
				$nombre_prepa = "/";
				$attaque_acide = "/";
				$nombre_grille = "/";
	...
	if ($detect_line == 1) {
		...
		if (((round(str_replace(",", ".", $nombre_fibre)) <> "0") && ($nombre_fibre <> "/")) || ($detect_fibre == 1)) $objPHPExcel->getActiveSheet()->getStyle('Y' . $line . ':Z' . $line)->applyFromArray($style_texte_alerte);
		if (((round(str_replace(",", ".", $nombre_fibre)) <> "0") && ($nombre_fibre <> "/")) || ($detect_fibre == 1)) $objPHPExcel->getActiveSheet()->getStyle('D' . $line)->applyFromArray($style_texte_alerte);
		if (((round(str_replace(",", ".", $nombre_fibre)) <> "0") && ($nombre_fibre <> "/")) || ($detect_fibre == 1)) $objPHPExcel->getActiveSheet()->getStyle('AD' . $line)->applyFromArray($style_texte_alerte);
	}
}
